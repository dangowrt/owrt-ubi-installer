...
RECOVERY="$(ls -1 $INSTALLER_DIR/openwrt-*mediatek-filogic-asus_zenwifi-bt8-ubootmod-initramfs-recovery.itb)"
HAS_ENV=1
HAS_FIP=1
HAS_FACTORY=1
...
install_prepare_ubi /dev/mtd$(find_mtd_index "NEW_UBI_DEV")
